...
db=Database("Employeee.db")
root=Tk()
root.title("Employeee Management System")
root.geometry("1090x1080+0+0")
...
btnAdd = Button(btn_frame,command=add_employeee,text="Add Details",width=15,font=("Calibri",16,"bold"),fg="white",bg="#16a085",bd=0).grid(row=0,column=0)

btnEdit = Button(btn_frame,command=update_employeee,text="Update Details",width=15,font=("Calibri",16,"bold"),fg="white",bg="#2980b9",bd=0).grid(row=0,column=1,padx=10)

btnDelete = Button(btn_frame,command=delete_employeee,text="Delete Details",width=15,font=("Calibri",16,"bold"),fg="white",bg="#c0392b",bd=0).grid(row=0,column=2,padx=10)
...
tree_frame.place(x=0, y=480, width=1988 ,height=520)
style = ttk.Style()
